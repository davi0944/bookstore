...
engine = create_engine('postgresql+psycopg2://postgres:258090@localhost:5432/bookstore?client_encoding=utf8',echo=True)
...
class BookDB:
    def __init__(self, large: bool = False):
        ...
        if large:
            ...
            self.book_db = "E:/bookstore-master/fe/data/book.db"
